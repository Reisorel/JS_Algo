function conversion(deg) {
  ...
  else return ("Données en entrée non-correctes")

}
// One liner
const conversion2 = deg => typeof deg === "number" ? Math.trunc(deg * (9/5) + 32) : "Données en entrée non-correctes"
/* ÉNONCÉ 📚 */
...
console.log("Voici les résultats de conversion");
...
console.log("Voici les résultats de conversion2");
