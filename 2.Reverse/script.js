...
console.log(reverse2("Bonjour à tous"));                         // suot à ruojnoB
console.log(reverse2("Être haut comme trois pommes"));           // semmop siort emmoc tuah ertÊ
console.log(reverse2("Ne pas chercher midi à quatorze heures")); // serueh ezrotauq à idim rehcrehc sap eN
