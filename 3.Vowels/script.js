...
const getVowelsNumber2 = txt => txt.match(/[aeiouy]/gi) ? txt.match(/[aeiouy]/gi).length : 0;
...
console.log(getVowelsNumber2("jdhqgdqsghdakzejamazemlqksd"));               // 5
console.log(getVowelsNumber2("Lorem ipsum dolor sit amet consectetur."));   // 13
console.log(getVowelsNumber2("L’imagination gouverne le monde."));          // 13
console.log(getVowelsNumber2("zzzZZZzz"));                                  // 0
